...
| `npm run test:unit` | 59 passed | Vitest, added August 22, 2026. Pure functions only (`tests/unit`); no DOM, no browser. |
| `npm run test:visual` | 38 passed, 0 failed | 38 tests, one Chromium worker. Exits zero. |
